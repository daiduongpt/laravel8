{{--
<section id="footer" class="bg-gray-800 border-t-8 border-orange-600  mt-10">
    <div class="container mx-auto xl:pl-0 xl:pr-0">
        <div class="grid grid-cols-1 md:grid-cols-3 text-left text-white pb-5 pl-5 pr-5">
            <p class="text-2xl font-bold mb-3 md:col-span-3">Theo Dõi Chúng Tôi</p>
